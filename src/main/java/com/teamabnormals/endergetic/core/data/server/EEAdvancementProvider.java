...
public class EEAdvancementProvider implements AdvancementGenerator {
	...
	public void generate(Provider provider, Consumer<Advancement> consumer, ExistingFileHelper helper) {
		Advancement poiseForest = createAdvancement("find_poise_forest", "end", ResourceLocation.parse("end/enter_end_gateway"), EEBlocks.POISMOSS.get(), AdvancementType.TASK, true, true, false)
		...
		Advancement eatBolloomFruit = createAdvancement("eat_bolloom_fruit", "end", poiseForest, EEItems.BOLLOOM_FRUIT.get(), AdvancementType.TASK, true, true, false)
		...
		// TODO: Eetle Update
		Advancement findEetleNest = createAdvancement("find_eetle_nest", "end", ResourceLocation.parse("end/enter_end_gateway"), EEBlocks.END_CORROCK_BLOCK.get(), AdvancementType.TASK, true, true, true)
	...
	private static Advancement.Builder createAdvancement(String name, String category, Advancement parent, ItemLike icon, AdvancementType frame, boolean showToast, boolean announceToChat, boolean hidden) {
