...
public enum BalloonColor {
	...
	BalloonColor(@Nullable DyeColor color, Supplier<Item> balloonItem) {
		...
		this.texture = color != null ? ResourceLocation.fromNamespaceAndPath(EndergeticExpansion.MOD_ID, String.format("textures/entity/balloon/%s_bolloom_balloon.png", color.getName())) : ResourceLocation.fromNamespaceAndPath(EndergeticExpansion.MOD_ID, "textures/entity/balloon/bolloom_balloon.png");
	}
