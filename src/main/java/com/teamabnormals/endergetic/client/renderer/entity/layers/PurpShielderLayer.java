...
public class PurpShielderLayer extends RenderLayer<Purpoid, PurpoidModel> {
	private final PurpoidModel purpazoidModel;
	private final PurpoidGelModel gelModel;

	public PurpShielderLayer(RenderLayerParent<Purpoid, PurpoidModel> parent, PurpoidModel purpazoidModel, PurpoidGelModel gelModel) {
		super(parent);
	...
	@Override
	public void render(PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, Purpoid purpoid, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
