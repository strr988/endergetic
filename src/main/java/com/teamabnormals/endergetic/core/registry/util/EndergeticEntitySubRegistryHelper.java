...
public class EndergeticEntitySubRegistryHelper extends EntitySubRegistryHelper {
	...
	public <E extends Entity> DeferredHolder<?, EntityType<E>> createUnsummonableEntity(String name, EntityType.EntityFactory<E> factory, MobCategory entityClassification, float width, float height) {
	...
	public <E extends Entity> DeferredHolder<?, EntityType<E>> createManuallyUpdatedEntity(String name, EntityType.EntityFactory<E> factory, MobCategory entityClassification, float width, float height) {
